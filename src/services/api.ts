 ...
 * @Date: 2022-12-26 10:25:25
 * @LastEditors: curechen 981470148@qq.com
 * @LastEditTime: 2022-12-26 16:39:31
 * @FilePath: \taro-netEase\src\services\api.ts
 * @Description: 封装网络请求方法
 */
...
export default {
  ...
  get(url, data?: object) {
    let option = { url, data }
    return this.baseMethod(option)
  },
  post: function (url, data?: object, contentType?: string) {
    let params = { url, data, contentType }
    return this.baseMethod(params, 'POST')
  },
  put(url, data?: object) {
    let option = { url, data }
    return this.baseMethod(option, 'PUT')
  },
  delete(url, data?: object) {
    let option = { url, data }
    return this.baseMethod(option, 'DELETE')
  }
}